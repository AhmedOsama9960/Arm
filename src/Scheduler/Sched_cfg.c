...
const Taskinfo_t Task_info[num] = {
	  ...
	  [Lower_Prio_3] = { .name = "Debounce"  , .Task_Cbf 	 = DebouncingSwitch, .Period = 10  , .Start_Delay = 0 },
	//[Lower_Prio_4] = { .name = "Switch"    , .Task_Cbf 	 = Switch		   , .Period = 20  , .Start_Delay = 0},
	  [Lower_Prio_4] = { .name = "LCD"       , .Task_Cbf 	 = LCD_Task		   , .Period = 5  , .Start_Delay = 50},
	  [Lower_Prio_5] = { .name = "LCD"       , .Task_Cbf 	 = LCD_App		   , .Period = 10  , .Start_Delay = 100}
